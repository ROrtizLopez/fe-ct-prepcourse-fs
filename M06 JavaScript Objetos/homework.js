...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   var num1 = objetoMisterioso.numeroMisterioso;
   var resultado = num1 * 5;
   return resultado;
}
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   let arrayAmigos = objetoUsuario.amigos 
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   objetoUsuario.posts.forEach(post => { sumaLikes += post.likes      
   });
   return sumaLikes;
   }
...
objetoProducto['calcularPrecioDescuento'] = function (){
   ...
   objetoProducto['precioFinal'] = objetoProducto.precio - valorDescuento;
